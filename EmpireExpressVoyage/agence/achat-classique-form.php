    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="achat-classique-form.php">
  ...
  <main>
    <br><br>
        ...
        <form class="needs-validation" action="billet.php" method="POST"novalidate>
          ...
          <input class="w-100 btn btn-primary btn-lg" type="submit" name="envoyer" value="Acheter le billet CLASSIQUE">
        </form>
    </main>
</div>
