   ...
   <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="tableau-classique.php">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h3">Passagers : CLASSIQUE</h3>
      </div>
  ...
  <?php
    ...
    foreach ($datavilled as $donnevilled){ 
      ...
      echo "<h4>Ville de Destination :"; echo $donnevilled['NomVilleD'];echo "</h4>";
         $sqlbilletpass = "SELECT * FROM achatligne, client, villed WHERE achatligne.fkIdVilleD = villed.IdVilleD AND achatligne.fkIdClient = client.IdClient AND achatligne.TypeBillet ='CLASSIQUE' AND achatligne.fkIdVilleD ='".$donnevilled['IdVilleD']."' "; 
