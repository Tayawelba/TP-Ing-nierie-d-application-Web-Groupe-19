...
<head>
	<meta charset="utf-8">
	<title>Achat d'un billet classique</title>
...
<div class="container">
  ...
  <main>
    <br><br>
        <h4 class="mb-3">Achat de Billet de classe Classique</h4>
        <form class="needs-validation"  action="billet-classique.php" method="POST" novalidate>
          <div class="row g-3">
        ...
        <div class="tab-content" id="nav-tabContent">
          ...
          <button class="w-100 btn btn-primary btn-lg" name="envoyer" type="submit">Acheter le billet Classique</button>
        </form>
    </main>
</div>
