...
<head>
	<meta charset="utf-8">
	<title>Réservation d'un billet classique</title>
...
<div class="container">
  ...
  <main>
    <br><br>
        <h4 class="mb-3">Réservation de Billet de classe Classique</h4>
        <form class="needs-validation" action="billet-reservation.php" method="POST" novalidate>
          <div class="row g-3">
          ...
          <input class="w-100 btn btn-primary btn-lg" type="submit" name="envoyer" value="Réserver le billet Classique">
        </form>
    </main>
</div>
